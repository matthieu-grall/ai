...
L'objectif est de **comparer les pratiques mises en oeuvre ou prévues pour le cas d'usage aux [bonnes pratiques de l'IA](https://github.com/matthieu-grall/ai/blob/main/IA%20-%20Gestion%20des%20risques%20-%20Bonnes%20pratiques.md)**, afin d'éclairer la prise de décision.
...
- dans l'atelier 4 : considérer les **attaques spécifiques aux systèmes d'IA** (ex : [Guide France IA] ou [ATLAS]) dans les « scénarios opérationnels » ;
- dans l'atelier 5 : considérer les **mesures spécifiques aux systèmes d'IA** (ex : [Guide France IA] ou [ATLAS]) dans les « mesures », ainsi que les recommandations ([Recos ANSSI], [Recos CNIL], etc.) qui n'auraient pas été retenues dans l'étape précédente.
